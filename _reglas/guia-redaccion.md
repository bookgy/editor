...
Esta guía convierte el criterio editorial de Agendic en decisiones concretas de escritura.

Debe utilizarse junto con:

- `contexto.md` para entender la marca y el público;
- `editorial.md` para decidir qué contar y desde qué ángulo;
- `_fuentes/oraculo.md` para confirmar cualquier hecho funcional.
...
Escribir para que una persona ocupada entienda rápidamente:
...
La utilidad tiene prioridad sobre el entusiasmo.
...
Escribir para una persona que trabaja en una empresa, no para “usuarios” abstractos.

Pensar en alguien que puede estar:

- atendiendo clientes;
- organizando agendas;
- revisando cobros;
- coordinando un equipo;
- gestionando varias herramientas;
...
Evitar salvo que exista una razón concreta:
...
No utilizar una cifra sin trazabilidad.
...
Pensar texto y creatividad como una sola pieza.

La idea debe entenderse muy rápido.
